...
def MFI_1D(HILLS="HILLS", position="position", bw=1, kT=1, min_grid=-2, max_grid=2, nbins=201, log_pace=10,
           ...
           uw_centre=0.0, uw_kappa=0, intermediate_fes_number = 0, Ftot_den_limit = 1E-10, FES_cutoff = 0, Ftot_den_cutoff = 0, F_static = 0):
    ...
    if type(F_static) is not np.ndarray: F_static = np.zeros(nbins)
